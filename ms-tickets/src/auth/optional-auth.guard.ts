...
export const EMPLOYEE_ROLES = ['admin', 'recaudador', 'root'];
 ...
 * (request.user queda undefined). Esto mantiene los endpoints de tickets
 * abiertos como hoy, pero permite saber "quién está logeado" cuando sí
 * se manda un token, para poblar id_empleado automáticamente.
 */
@Injectable()
