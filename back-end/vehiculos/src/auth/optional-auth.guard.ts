 ...
 * (request.user queda undefined). Esto mantiene los endpoints de vehículos
 * abiertos como hoy, pero permite saber "quién" realizó cada acción cuando
 * sí se manda un token, para poblar la auditoría.
 */
@Injectable()
