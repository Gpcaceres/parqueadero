...
export class VehiculosService {
  ...
  async createVehiculo(
    ...
    await this.emitEvent('CREATE', saved, undefined, ip, usuario, rol);
  ...
  async update(
    ...
    const saved = await this.vehiculoRepository.save(vehiculo);
    await this.emitEvent('UPDATE', saved, undefined, ip, usuario, rol);
  ...
  async remove(id: string, ip?: string, usuario?: string, rol?: string): Promise<void> {
    ...
    await this.emitEvent('DELETE', vehiculo, undefined, ip, usuario, rol);
  }
