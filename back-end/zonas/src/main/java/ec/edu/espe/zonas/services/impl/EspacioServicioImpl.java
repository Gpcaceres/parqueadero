...
public class EspacioServicioImpl implements EspacioService {
    ...
    @Override
    @Transactional
    public EspacioResponseDto crearEspacio(EspacioRequestDto dto, String ip, String usuario, String rol) {
        ...
        auditEventPublisher.publicar("CREATE", "ESPACIO", responseDto, ip, usuario, rol);
    ...
    @Override
    @Transactional
    public EspacioResponseDto actualizarEspacio(UUID idEspacio, EspacioRequestDto request, String ip, String usuario, String rol) {
        Espacio espacioExistente = repositorioEspacio.findById(idEspacio)
                .orElseThrow(() -> new RecursoNoEncontradoException("Espacio no encontrado con ID: " + idEspacio));
        
        Zona objZona = zonaRepository.findById(request.getIdZona())
                .orElseThrow(() -> new RecursoNoEncontradoException("Zona no encontrada con ID: " + request.getIdZona()));
        ...
        auditEventPublisher.publicar("UPDATE", "ESPACIO", responseDto, ip, usuario, rol);
    ...
    @Override
    @Transactional
    public void activarDesactivar(UUID idEspacio, String ip, String usuario, String rol) {
        Espacio espacio = repositorioEspacio.findById(idEspacio)
                .orElseThrow(() -> new RecursoNoEncontradoException("Espacio no encontrado con ID: " + idEspacio));
        ...
        auditEventPublisher.publicar("UPDATE", "ESPACIO", mapper.toResponseDto(espacioActualizado), ip, usuario, rol);
    }
}